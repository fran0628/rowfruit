		...
		<>
			...
			<main>
				...
				<div className="container mt-5">
					<div className="container row m-0">
						...
						<div className="sliderword col-lg-4 col-md-4">
							...
							<p className="text-center fs-5">全新水果生活</p>
							<p className="text-center fs-5">ROWFRUIT為您配送</p>
							<p className="text-center fs-5">訂閱制水果盒</p>
				...
				<div className="container">
					...
					<p className="text-center fs-6">
						訂閱制(月訂閱制/季訂閱制/半年訂閱制)之後為每週一至週三出貨(
						週一至週四間配送 )
					</p>
				</div>
				{/*水果盒*/}
